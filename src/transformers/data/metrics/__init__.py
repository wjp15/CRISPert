...
if _has_sklearn:
    ...
    def simple_aucpr(preds,labels,probs):
    ...
    def acc_f1_mcc_auc_pre_rec(preds, labels, probs):
        ...
        aucpr = average_precision_score(y_true=labels,y_score=probs) # code added
    ...
    def glue_compute_metrics(task_name, preds, labels, probs=None):
        ...
        elif task_name in ["dna690", "dnapair","dnacrispr","dnacrispr2","dnaextend10"]:
