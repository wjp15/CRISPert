...
class InputExample(object):
    ...
    def __init__(self, guid, text_a, text_b=None,text_c=None, label=None, feature_a=None, feature_b=None, feature_c=None, feature_d=None):
        self.guid = guid
        self.text_a = text_a
        self.text_b = text_b
        self.text_c = text_c
...
class InputFeatures(object):
    ...
    def __init__(self, input_ids, attention_mask=None, token_type_ids=None, label=None, feature_a_ids=None,feature_b_ids=None,feature_c_ids=None,feature_d_ids=None,features_comb=None,input_ids2=None,attention_mask2=None,token_type_ids2=None):
        self.input_ids = input_ids
        self.attention_mask = attention_mask
        self.token_type_ids = token_type_ids
        self.label = label
        self.feature_a_ids = feature_a_ids
        self.feature_b_ids = feature_b_ids
        self.feature_c_ids = feature_c_ids
        self.feature_d_ids = feature_d_ids
